...
if __name__ == '__main__':
    ...
    parameter_group.add_argument('--min-coverage', action="store", dest="min_coverage", default=15, required=False, help='Minimum coverage for calling variants [10]')
    ...
    parameter_group.add_argument('--filter-density-window', action="store", dest="filter_density_window", default=100, required=False, help='Window size for identifying high-density SNV regions [20]')
    parameter_group.add_argument('--filter-density-threshold', action="store", dest="filter_density_threshold", default=10, required=False, help='SNV threshold for identifying high-density SNV regions [2]')
